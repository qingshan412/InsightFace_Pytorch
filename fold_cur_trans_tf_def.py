...
if __name__ == '__main__':
    ...
    for fold_idx in range(args.kfold):
        ...
        conf_train.emore_folder = conf.data_path/'faces_emore_trans_tf_def'
    ...
    name_path = os.path.join(args.stored_data_dir, 'names_trans_tf_def.npy')
    save_label_score(name_path, exp_name)
    label_path = os.path.join(args.stored_data_dir, 'labels_trans_tf_def.npy')
    save_label_score(label_path, score_names)
    score_path = os.path.join(args.stored_data_dir, 'scores_trans_tf_def.npy')
