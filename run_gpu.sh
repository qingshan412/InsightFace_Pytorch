...
python roc_acc_fold.py -g $CUDA_VISIBLE_DEVICES -s -a "fake_noonan_raw" > data/facebank/roc_raw_112_s_a_raw
python roc_acc_fold.py -g $CUDA_VISIBLE_DEVICES -tta -a "fake_noonan_raw" > data/facebank/roc_raw_112_tta_a_raw
python roc_acc_fold.py -g $CUDA_VISIBLE_DEVICES -s -tta -a "fake_noonan_raw" > data/facebank/roc_raw_112_s_tta_a_raw
# python roc_acc_fold.py -g $CUDA_VISIBLE_DEVICES -a "fake_noonan_raw" > data/facebank/roc_raw_112_a_raw
