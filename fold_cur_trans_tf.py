...
if __name__ == '__main__':
    ...
    # prepare folders
    raw_dir = 'raw_112'
    verify_type = 'trans_tf' #'train_train'
    if args.tta:
        verify_type += '_tta'
    if args.use_shuffled_kfold:
    ...
    name_path = os.path.join(args.stored_data_dir, 'names_trans_tf.npy')
    save_label_score(name_path, exp_name)
    label_path = os.path.join(args.stored_data_dir, 'labels_trans_tf.npy')
